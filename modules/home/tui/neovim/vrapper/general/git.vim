...
" doc: Compare working tree with commit
vnoremap <leader>ghD    :git_compareWithCommit<cr>
...
" doc: Blame NOTE: Do it twice if it does not work
nnoremap <leader>gb    :git_toggleRevisionId<cr>:git_toggleRevisionAuthor<cr>:git_annotate<cr>
" doc: Blame NOTE: Do it twice if it does not work
vnoremap <leader>gb    :git_toggleRevisionId<cr>:git_toggleRevisionAuthor<cr>:git_annotate<cr>
